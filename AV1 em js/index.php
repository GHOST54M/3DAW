...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    function enviarProduto() {
          ...
          xhr.open("POST", "inserir_produto.php", true);
          xhr.onload = function() {
            if (xhr.status == 200) {
  ...
  <body>
    ...
    <section id="operacoes_menu">
        <form method="POST" id="formulario" action="">
            ...
            <input type="submit" value="Adicionar ao Carrinho"  onclick="return enviarProduto();">

        </form>
        <a href="cadastrar_produto.html">Cadastrar produto</a>
